    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, default=None, null=True,
                                              on_delete=django.db.models.deletion.CASCADE, related_name='account', to='transactions.Savings')),
                ('transaction', models.ForeignKey(blank=True, default=None, null=True,
                                                  on_delete=django.db.models.deletion.CASCADE, related_name='deposits', to='transactions.Transaction')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('CRA', 'CREDIT ACCOUNT'), (
                    'CUR', 'CURRENT ACCOUNT'), ('SAV', 'SAVINGS ACCOUNT')], default='CRA', max_length=3)),
