    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[
                 ('B', 'BUILDING'), ('E', 'EMPTY LOT')], default='B', max_length=1)),
                ...
                ('image_others', django.contrib.postgres.fields.ArrayField(
                    base_field=models.URLField(unique=True), blank=True, default=list, size=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                related_name='enquiry_requester', to=settings.AUTH_USER_MODEL)),
                ('target_property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                            related_name='property_of_interest', to=settings.AUTH_USER_MODEL)),
                ('listed_property', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, related_name='property', to='property.Property')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
