    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_others', django.contrib.postgres.fields.ArrayField(base_field=models.URLField(unique=True), blank=True, default=list, size=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enquiry_requester', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            name='BuyerPropertyList',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='property_of_interest', to=settings.AUTH_USER_MODEL)),
                ('listed_property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='property', to='property.Property')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
