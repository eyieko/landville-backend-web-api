# Generated by Django 2.2.1 on 2019-07-12 10:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inspection_mode', models.CharField(choices=[
                 ('P', 'PHYSICAL INSPECTION'), ('V', 'VIDEO INSPECTION')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('enquiry_id', models.CharField(blank=True,
                                                default=uuid.uuid4,
                ...
                ('client', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    related_name='client', to='authentication.Client')),
                ('requester', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listed_property', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    related_name='property', to='property.Property')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
