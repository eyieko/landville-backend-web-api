# Generated by Django 2.2.1 on 2019-08-16 12:45
...
class Migration(migrations.Migration):
    ...
    replaces = [('property', '0001_initial')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(
                    choices=[('B', 'BUILDING'), ('E', 'EMPTY LOT')],
                ...
                ('image_others', django.contrib.postgres.fields.ArrayField(
                    base_field=models.URLField(unique=True), blank=True,
                    default=list, size=15)),
                ('video', models.URLField(blank=True, null=True, unique=True)),
                ('view_count', models.IntegerField(default=0)),
                ('last_viewed', models.DateTimeField(blank=True, null=True)),
                ('purchase_plan', models.CharField(
                    choices=[('I', 'INSTALLMENTS'), ('F', 'FULL PAYMENT')],
                    max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_property',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   related_name='reviewed_property',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inspection_mode', models.CharField(
                    choices=[('P', 'PHYSICAL INSPECTION'),
                             ('V', 'VIDEO INSPECTION')], default='P',
                    max_length=1)),
                ('requester',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                ...
                ('target_property',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   related_name='inspected_property',
                                   to='property.Property')),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('enquiry_id', models.CharField(blank=True, default=uuid.uuid4,
                ...
                ('requester',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   related_name='enquiry_requester',
                                   to=settings.AUTH_USER_MODEL)),
                ('target_property',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   related_name='enquired_property',
                                   to='property.Property')),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   related_name='property_of_interest',
                                   to=settings.AUTH_USER_MODEL)),
                ('listed_property',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
