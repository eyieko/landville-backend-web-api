...
from tests.factories.property_factory import PropertyFactory, PropertyEnquiryFactory, PropertyInspectionFactory, PropertyReviewFactory
...
class BaseTest(TestCase):
    ...
    def setUp(self):
        ...
        self.property_update = {
            "price": 99999999.99, "bathrooms": 3, "garages": 4, "title": "Updated Super Lot",
            "image_others": ["http://www.example.com", "http://wwww.dopest.house"]
        }

        self.invalid_address_update = {
            "address": {"City": "", "State": "TestVille", "Street": "Tee Street"},
        }

        self.property_renderer = PropertyJSONRenderer()

        self.serialized_property_sample = '{"data": {"properties": {"results": [{"price": 999999.99, "lot_size": 342.43, "address": {"City": "Lagos", "State": "Greater Lagos", "Street": "Lagos St"}, "coordinates": {"lat": 1234234.43, "lon": 324534554.45}, "title": "Test Property", "description": "This is a dummy propery. Duh", "bedrooms": null, "bathrooms": null, "garages": null, "image_main": "https://www.dope.image/main", "purchase_plan": "I", "client": 1}]}}}'
