...
class Migration(migrations.Migration):
    ...
    replaces = [('authentication', '0001_initial')]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(
                    choices=[('LA', 'LANDVILLE ADMIN'), ('CA', 'CLIENT ADMIN'),
                             ('BY', 'BUYER')], default='BY', max_length=2,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_level', models.CharField(
                    choices=[('STARTER', 'STARTER'), ('BUYER', 'BUYER'),
            ...
            fields=[
                ...
                ('review',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   ...
                                   to='authentication.ClientReview')),
                ('reviewer',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   related_name='reply',
                                   to=settings.AUTH_USER_MODEL)),
